...
if __name__ == '__main__':
    ...
    input_dir = r"C:\Users\cyzho\Desktop\data_semantics\training"
    output_dir = r"C:\Users\cyzho\Desktop\data_semantics\training\kitti"
    ...
    for f in semantic_file_list:
        ...
        out_instance_filename = join(out_instance_dir,'%s_instanceIds.png'%f[:-4])
